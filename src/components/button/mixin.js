...
import colorPalette from '@components/theme/color/color-palette'
import { square } from '@components/style/mixins/size'
  ...
  const mixins = {
    ...
    buttonDisabled() {
      return css`
        ...
        &[disabled] {
          ...
          &.active {
            ${mixins.buttonColor(
              theme.btnDisableColor,
              theme.btnDisableBg,
              theme.btnDisableBorder,
            )};
          }
        }
      `
    ...
    btn() {
      return css`
        ...
        ${mixins.buttonSize(
          theme.btnHeightBase,
          theme.btnPaddingBase,
          theme.fontSizeBase,
          theme.btnBorderRadiusBase,
        )} user-select: none;
        transition: all 0.3s ${theme.easeInOut};
        position: relative;
        > .${theme.iconfontCssPrefix} {
          line-height: 1;
        }
    ...
    btnDefault() {
      return css`
        ${mixins.buttonVariantOther(
          theme.btnDefaultColor,
          theme.btnDefaultBg,
          theme.btnDefaultBorder,
        )} &:hover,
        &:focus,
        &:active,
        &.active {
    ...
    btnDanger() {
      return css`
        ${mixins.buttonVariantDanger(
          theme.btnDangerColor,
          theme.btnDangerBg,
          theme.btnDangerBorder,
        )};
      `
    },
    ...
    btnCircle(btnClassName: btn) {
      return css`
        ...
        ${mixins.buttonSize(
          theme.btnCircleSize,
          0,
          add(theme.fontSizeBase, '2px'),
          '50%',
        )}
        &.${btnClassName}-lg {
          ${square(theme.btnCircleSizeLg)}
          ${mixins.buttonSize(
            theme.btnCircleSizeLg,
            0,
            add(theme.btnFontSizeLg, '2px'),
            '50%',
          )}
        }
        &.${btnClassName}-sm {
